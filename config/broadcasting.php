...
return [
    ...
    */
    ...
    | used when broadcasting queued events. By default, Laravel will use
    | the default queue connection specified in your queue config file.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | If the selected broadcaster is not available, you can specify a fallback
    | broadcaster to use. This is useful for local development or failover.
    |
    */
