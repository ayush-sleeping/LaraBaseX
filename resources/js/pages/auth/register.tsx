                                ...
                                <form className="p-6 md:p-8" onSubmit={submit}>
                                    <div className="flex flex-col gap-6">
                                        ...
                                        <div className="text-center text-sm">
                                            ...
                                            <TextLink href={route('login')} className="underline underline-offset-4" tabIndex={7}>
                                                Log in
                                            </TextLink>
                                        </div>
                                    </div>
